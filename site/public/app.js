...
(function(){
  ...
  var config = {
    apiKey: "AIzaSyB-6sdsQgB8-Vu7oZUlXC_zXxVAMcMXm90",
    authDomain: "horta-auto.firebaseapp.com",
    databaseURL: "https://horta-auto-default-rtdb.firebaseio.com",
    storageBucket: "horta-auto.appspot.com",
    messagingSenderId: "G-4HK5B5G86N"
  };
  ...
  soloRef.on('value', onNewData('currentSolo', 'soloLineChart' , 'Solo', '%'));
